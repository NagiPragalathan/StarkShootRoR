...
const navigation = [
  { name: "How it works", href: "https://starkshoot.gitbook.io/home/" },
];
        ...
        >
          ...
          <div className="flex items-center gap-4 border-[#161B32] border-[6px] px-4 py-2 rounded-full lg:flex">
            ...
            <a href="#" className="-m-1.5 p-1.5">
              <img alt="Starkshoot" src="./logo.svg" className="h-16 w-auto " />
            </a>
            <button>
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-[#e79f2b] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">StarkShoot</span>
                <img alt="StarkShoot" src={navicon} className="h-10 w-auto" />
              </a>
              <button
                type="button"
