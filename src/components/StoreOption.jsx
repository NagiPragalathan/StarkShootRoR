...
const itemsData = {
  ...
  WEAPONS: [
    ...
    { name: "Sniper_2", price: "1200 STK", stats: { dmg: 98, rate: 15, range: 98 }, desc: "Advanced tactical sniper with integrated noise suppressor." },
    ...
    { name: "Revolver", price: "400 STK", stats: { dmg: 50, rate: 30, range: 45 }, desc: "High-caliber handgun for precise, powerful shots." },
    { name: "Revolver_Small", price: "FREE", stats: { dmg: 45, rate: 35, range: 40 }, desc: "Compact high-power revolver for quick draws." },
    { name: "ShortCannon", price: "1100 STK", stats: { dmg: 95, rate: 10, range: 35 }, desc: "Miniaturized artillery pieces for massive short-range impact." },
    { name: "Knife_1", price: "FREE", stats: { dmg: 35, rate: 85, range: 5 }, desc: "Standard tactical combat knife for silent eliminations." },
    { name: "Knife_2", price: "250 STK", stats: { dmg: 45, rate: 90, range: 5 }, desc: "Shadow-ops karambit designed for rapid lethal strikes." },
  ...
  MAPS: [
    ...
    { name: "city side map", price: "400 STK", model: "/models/city_side_map.glb", desc: "Metropolitan zone featuring vertical gameplay opportunities." },
    { name: "living room", price: "400 STK", model: "/models/living_room.glb", desc: "Intricate indoor environment for tactical CQB." },
    { name: "grave house map", price: "400 STK", model: "/models/grave_house_map.glb", desc: "Atmospheric, low-visibility stealth combat theater." },
    { name: "broken house map", price: "400 STK", model: "/models/broken_house_map.glb", desc: "Ruined sector with complex line-of-sight challenges." },
  ]
};
        ...
        <div className="flex items-center space-x-6">
          <div className="flex flex-col items-end">
            ...
            <div className="text-2xl font-black text-lime tracking-tighter tabular-nums flex items-center">
              <span className="text-xs mr-2">STK</span> {credits.toLocaleString()}
            </div>
          </div>
